...
app.get('/student/:id/quiz-review', async(req,res)=>{
  ...
  const reviewHtml=repaired.review.length?renderAttemptReview(repaired.review,old.score,true):`<div class="alert"><b>This older attempt has no recoverable question snapshot.</b> New v4.3 attempts are stored permanently.</div>`;
  res.send(layout('Quiz Review', `<div class="card"><div class="eyebrow">Legacy Quiz Record · v4.3 Recovery</div><div class="big">Quiz Review</div>${reviewHtml}<div class="toolbar" style="margin-top:16px"><a class="btn" href="/student/${s.id}/quiz?token=${encodeURIComponent(s.join_token)}">Retake Quiz</a><a class="btn light" href="/student/${s.id}?token=${encodeURIComponent(s.join_token)}">Back to Training</a></div></div>`));
});
...
function certificateMarkup(s, cert, startDate, endDate, backHref=''){
  ...
  return {
    ...
    css:`<style>
      ...
      .cert-dealer-line{position:absolute;left:130px;right:62px;top:326px;border-top:2px solid #222}
      ...
      .manager-signature{display:block;width:210px;height:54px;object-fit:contain;margin:0 auto 0}
      ...
      @media print{
        ...
        .cert-dealer-line{left:1.15in;right:.5in;top:2.85in}
        ...
        .manager-signature{width:1.8in;height:.47in}
