...
app.get('/student/:id/quiz-review', async(req,res)=>{
  ...
  const reviewHtml=repaired.review.length?renderAttemptReview(repaired.review,old.score,true):`<div class="alert"><b>This older attempt has no recoverable question snapshot.</b> New v4.3.1 attempts are stored permanently.</div>`;
  res.send(layout('Quiz Review', `<div class="card"><div class="eyebrow">Legacy Quiz Record · v4.3.1 Recovery</div><div class="big">Quiz Review</div>${reviewHtml}<div class="toolbar" style="margin-top:16px"><a class="btn" href="/student/${s.id}/quiz?token=${encodeURIComponent(s.join_token)}">Retake Quiz</a><a class="btn light" href="/student/${s.id}?token=${encodeURIComponent(s.join_token)}">Back to Training</a></div></div>`));
});
...
function certificateMarkup(s, cert, startDate, endDate, backHref=''){
  ...
  return {
    ...
    css:`<style>
      ...
      .cert-dealer-line{position:absolute;left:220px;right:220px;top:326px;border-top:2px solid #222}
      ...
      .cert-course-line{position:absolute;left:460px;right:165px;top:458px;border-top:2px solid #222}
      ...
      .sig-block{position:absolute;width:350px;text-align:center;font-family:Arial,sans-serif;font-size:16px;line-height:1.15}
      .instructor-signature-block{left:125px;top:670px}
      .nazar-signature-block{right:125px;top:670px}
      .typed-signature{height:54px;display:flex;align-items:flex-end;justify-content:center;font-family:'Segoe Script','Brush Script MT',cursive;font-size:34px;font-style:italic;line-height:1}
      .manager-signature{display:block;width:300px;height:82px;object-fit:contain;margin:0 auto -2px}
      .sig-line{border-top:2px solid #222;margin:4px auto 8px;width:320px}
      ...
      @media print{
        ...
        .cert-dealer-line{left:1.85in;right:1.85in;top:2.85in}
        ...
        .cert-course-line{left:4.05in;right:1.3in;top:4.0in}
        ...
        .sig-block{width:3.1in;font-size:11.5pt}
        .instructor-signature-block{left:1.05in;top:5.88in}
        .nazar-signature-block{right:1.05in;top:5.88in}
        .typed-signature{height:.47in;font-size:24pt}
        .manager-signature{width:2.7in;height:.72in}
        .sig-line{width:2.85in;margin:.04in auto .06in}
